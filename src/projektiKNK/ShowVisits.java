...
public class ShowVisits extends VBox {
	...
	private TableColumn<Visit,String> column7 = new TableColumn<>("Doctor Name");
	private TableColumn<Visit,String> column8 = new TableColumn<>("Doctor Lastname");
	private TableColumn<Visit,String> column9 = new TableColumn<>("Description");
	...
	public ShowVisits()
	{
		...
		column8.setCellValueFactory(new PropertyValueFactory("ldname"));
		column8.setPrefWidth(200);
		
		
		column9.setCellValueFactory(new PropertyValueFactory("description"));
		column9.setPrefWidth(200);
		
		
		
		setPadding(new Insets(10,10,10,10));
		
		table1.getColumns().addAll(column1,column2,column3,column4,column5,column6,column7,column8,column9);
